        ...
        <body>
          ...
          <div class="cont">
            <div class="dd">
              <center>
                 <div class="loginform">
                  <br><center><h2>User Profile</h2><br></center>
              ...
              while($row = mysqli_fetch_array($result))
              {
               echo '<img class="" src="'.$row['userimg'].'" alt= "Image" height="120" width="120" ><br><br>';
                  ...
                  if($member > 0)
                  {
                    ...
                    $sql2 = "SELECT * FROM membership WHERE mem_id ='".$member."' limit 1";
                ...
                ?>
                                ...
                                <div class="df">
                                <a href="adminhome.php"><button class="logout">back</button></a>
                                </div>
                    <?php
                              }
                            }
